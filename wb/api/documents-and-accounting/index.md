...
Просмотр [баланса](./documents-and-accounting#tag/balance), [финансовых отчётов](./documents-and-accounting#tag/financialReports) и [документов](./documents-and-accounting#tag/documents) продавца.
