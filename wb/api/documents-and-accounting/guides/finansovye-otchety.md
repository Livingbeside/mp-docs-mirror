...
Методы получения:
 1. [Списка](./financial-reports-and-accounting#tag/financialReports/operation/postV1SalesReportsList) отчётов реализации и детализаций к отчётам по [ID](./financial-reports-and-accounting#tag/financialReports/operation/postV1SalesReportsDetailedReportId) и за [период](./financial-reports-and-accounting#tag/financialReports/operation/postV1SalesReportsDetailed)
 2. [Списка](./financial-reports-and-accounting#tag/financialReports/operation/postV1AcquiringList) отчётов об издержках на приём платежей и детализаций к отчётам по [ID](./financial-reports-and-accounting#tag/financialReports/operation/postV1AcquiringDetailedReportId) и за [период](./financial-reports-and-accounting#tag/financialReports/operation/postV1AcquiringDetailed). Доступно только для продавцов из России
