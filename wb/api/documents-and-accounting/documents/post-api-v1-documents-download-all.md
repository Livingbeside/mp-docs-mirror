...
Метод загружает несколько документов из [списка документов продавца](./documents-and-accounting#tag/documents/operation/getV1DocumentsList).
