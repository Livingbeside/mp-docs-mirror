---
title: Получить цены продавца и суммы к оплате{{ /api/marketplace/v3/click-collect/orders/final-price }}
...
deprecated: false
content_sha: 4642e76c6cb3120e
---

# Получить цены продавца и суммы к оплате{{ /api/marketplace/v3/click-collect/orders/final-price }}
