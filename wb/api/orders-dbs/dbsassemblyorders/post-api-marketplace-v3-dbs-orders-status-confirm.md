---
title: Перевести сборочные задания на сборку{{ /api/marketplace/v3/dbs/orders/status/confirm }}
api: wb-orders-dbs
method: POST
