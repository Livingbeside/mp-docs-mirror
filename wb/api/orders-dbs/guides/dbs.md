...
Управление [сборочными заданиями](./orders-dbs#tag/dbsAssemblyOrders) и [идентификаторами маркировки](./orders-dbs#tag/dbsLabelIdentifiers) DBS (Delivery by Seller).
