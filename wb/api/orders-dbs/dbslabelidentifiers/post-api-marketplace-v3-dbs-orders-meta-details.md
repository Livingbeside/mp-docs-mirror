---
title: Получить идентификаторы маркировки сборочных заданий{{ /api/marketplace/v3/dbs/orders/meta/details }}
api: wb-orders-dbs
method: POST
