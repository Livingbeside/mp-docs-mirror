---
title: Стоимость возврата продавцу
api: wb-rates
tag: returnCostToSeller
group: ""
kind: guide
...
Стоимость возврата продавцу можно получить с токеном любой [категории](./api-information#tag/authorization/Kategorii-tokenov)
