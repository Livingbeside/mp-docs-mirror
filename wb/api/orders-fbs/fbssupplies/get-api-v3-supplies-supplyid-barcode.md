...
operation_id: getV3SuppliesSupplyIdBarcode
tags:
  - fbsSupplies
spec_version: order
source: "https://dev.wildberries.ru/docs/openapi/orders-fbs"
deprecated: false
content_sha: 4b767bc660244aa1
---
...
Метод возвращает QR-код [поставки](./orders-fbs#tag/fbsSupplies/operation/getV3SuppliesSupplyId) в форматах:
 - SVG
 - ZPLV (вертикальный)
 - ZPLH (горизонтальный)
 - PNG

QR-код поставки можно получить, только если поставка [передана в доставку](./orders-fbs#tag/fbsSupplies/operation/patchV3SuppliesSupplyIdDeliver).
