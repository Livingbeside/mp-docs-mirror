...
operation_id: putV3PassesPassId
tags:
  - fbsPasses
spec_version: order
source: "https://dev.wildberries.ru/docs/openapi/orders-fbs"
deprecated: false
content_sha: 6af2c13d42a716e1
---
...
Метод обновляет данные [пропуска продавца](./orders-fbs#tag/fbsPasses/operation/getV3Passes). В том числе, можно обновить данные привязанного склада WB.
