...
Для работы с поставками:
 ...
 1. [Установите параметры отгрузки поставки](./orders-fbs#tag/Postavki-FBS/operation/patchV3FbsSuppliesShippingMethod). Для этого получите [список пунктов отгрузки поставок](./work-with-products#tag/Sklady-prodavca/operation/getV3FbsShippingPoints). Доступно только для продавцов из РФ.
