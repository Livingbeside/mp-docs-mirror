...
operation_id: postV3OrdersStickers
tags:
  - fbsAssemblyOrders
spec_version: order
source: "https://dev.wildberries.ru/docs/openapi/orders-fbs"
deprecated: false
content_sha: bf66d76ab5abea03
---
...
Метод возвращает список стикеров для [сборочных заданий](./orders-fbs#tag/fbsAssemblyOrders) в [статусах](./orders-fbs#tag/fbsAssemblyOrders/operation/postV3OrdersStatus) `confirm` — на сборке и `complete` — в доставке. 

Если за сборочным заданием не закреплён обязательный [номер декларации на товары (ДТ)](./orders-fbs#tag/fbsLabelIdentifiers/operation/putV3OrdersOrderIdMetaCustomsDeclaration), получить стикеры для этого сборочного задания невозможно.
