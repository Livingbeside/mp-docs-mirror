...
operation_id: postV3OrdersStatusHistory
tags:
  - fbsAssemblyOrders
spec_version: order
source: "https://dev.wildberries.ru/docs/openapi/orders-fbs"
deprecated: false
content_sha: 7b90c439768e201e
---
...
Метод возвращает историю [статусов](./orders-fbs#tag/fbsAssemblyOrders/operation/postV3OrdersStatus) для [сборочных заданий](./orders-fbs#tag/fbsAssemblyOrders/operation/getV3Orders) трансграничных поставок.
