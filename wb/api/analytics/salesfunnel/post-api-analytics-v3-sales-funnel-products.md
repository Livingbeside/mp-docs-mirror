---
title: Статистика карточек товаров за период{{ /api/analytics/v3/sales-funnel/products }}
api: wb-analytics
method: POST
