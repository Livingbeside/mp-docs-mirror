---
title: Обновление пункта приема и таймслота
api: uzum-seller
method: POST
path: /v1/fbs/invoice/dop/time-slot
operation_id: updateDropOffPointAndTimeSlot
tags:
  - FBS Invoice
spec_version: 1.0.0
source: "https://api-seller.uzum.uz/api/seller-openapi/swagger/swagger-ui/swagger-ui/index.html"
deprecated: false
content_sha: 9153d31a86eb2c05
---

# Обновление пункта приема и таймслота
...
**400** — Коды ошибок: seller-order-04 - Позиция накладной не найдена seller-order-19 - Накладная не найдена seller-order-23 - Таймслот недоступен
