...
<!-- source: ru/api/regions/searchRegionsByName.md -->
<div class="openapi">
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/searchRegionsByName.md -->
  ...
  * all-methods:read-only — Просмотр всех данных
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/searchRegionsByName.md -->
  ...
  <!-- source: ru/_auto/method_limits/searchRegionsByName.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 50 000 регионов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/searchRegionsByName.md -->
  ...
  **Type**: string
  ...
  _regions_{.json-schema-reset .json-schema-property .json-schema-required}
  {.table-cell}|
...
- Console
  ...
  searchParams:
    - description: >
        ...
        Важно учитывать регистр: первая буква должна быть заглавной, остальные —
        строчными. Например, `Москва`.
      name: name
      in: query
      required: true
      schema:
...
<!-- endsource: ru/api/regions/searchRegionsByName.md -->
