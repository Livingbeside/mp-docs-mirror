...
fetched_at: "2026-08-28T11:53:20Z"
content_sha: 16b71dd938a398b8
---
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/searchRegionChildren.md -->
  ...
  * all-methods:read-only — Просмотр всех данных
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/searchRegionChildren.md -->
  
  Возвращает информацию о регионах, являющихся дочерними по отношению к региону, идентификатор которого указан в запросе.
  
  <!-- source: ru/_auto/method_limits/searchRegionChildren.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 1 000 дочерних регионов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/searchRegionChildren.md -->
  ...
  **Type**: integer
  ...
  Идентификатор региона можно получить c помощью запроса [GET v2/regions](https://yandex.ru/dev/market/partner-api/doc/ru/reference/regions/searchRegionsByName.md).
  ...
  **Type**: [PackagingForwardScrollingPagerDTO](#entity-PackagingForwardScrollingPagerDTO)
  ...
  _regions_{.json-schema-reset .json-schema-property}
  {.table-cell}|
  **Type**: [RegionWithChildrenDTO](#entity-RegionWithChildrenDTO)
  ...
  **Type**: [RegionDTO](#entity-RegionDTO)
  ...
  ### RegionWithChildrenDTO {#entity-RegionWithChildrenDTO}
  ...
  **Type**: object
  ...
  - {% cut "**Type**: object" %}
    ...
    {.table-cell}|
    **Type**: [RegionDTO](#entity-RegionDTO)[] &#124; null
...
- Console
  ...
  pathParams:
    - description: "Идентификатор региона.\n\nИдентификатор региона можно получить c помощью запроса [GET\_v2/regions](../../reference/regions/searchRegionsByName.md).\n"
      name: regionId
      in: path
      required: true
      schema:
...
<!-- endsource: ru/api/regions/searchRegionChildren.md -->
