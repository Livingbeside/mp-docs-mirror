...
fetched_at: "2026-09-24T02:14:57Z"
content_sha: b461f006dff2688a
---
...
alternate:
  ...
  - https://yandex.ru/dev/market/partner-api/doc/zh/reference/regions/searchRegionsById.md
  - href: https://yandex.ru/dev/market/partner-api/doc/ru/reference/regions/searchRegionsById.md
    type: text/markdown
...
<!-- source: ru/api/regions/searchRegionsById.md -->
<div class="openapi">
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/searchRegionsById.md -->
  ...
  * all-methods:read-only — Просмотр всех данных
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/searchRegionsById.md -->
  
  Возвращает информацию о регионе.
  
  <!-- source: ru/_auto/method_limits/searchRegionsById.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 10 000 запросов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/searchRegionsById.md -->
  ...
  **Type**: [RegionDTO](#entity-RegionDTO)
  ...
  _regions_{.json-schema-reset .json-schema-property .json-schema-deprecated}_[ ](*Deprecated)_{.openapi-deprecated .openapi-deprecated-compact}
  {.table-cell}|
  **Type**: [RegionDTO](#entity-RegionDTO)[] &#124; null
  ...
  В массиве всегда возвращается один регион, используйте поле `region` вместо него.
...
<!-- endsource: ru/api/regions/searchRegionsById.md -->
