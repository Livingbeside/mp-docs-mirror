...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/getOrder.md -->
  ...
  * all-methods:read-only — Просмотр всех данных
  ...
  {% endnote %}
  <!-- endsource: ru/_auto/method_scopes/getOrder.md -->
  ...
  <!-- source: ru/_auto/method_limits/getOrder.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 10 000 запросов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/getOrder.md -->
...
<!-- endsource: ru/api/orders/getOrder.md -->
