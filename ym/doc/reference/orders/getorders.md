...
fetched_at: "2026-09-15T02:23:01Z"
content_sha: 65f857fa19258ad7
---
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/getOrders.md -->
  ...
  * all-methods:read-only — Просмотр всех данных
  ...
  {% note warning "Метод устарел, с 18 января 2027 будет работать нестабильно и будет отключен 12 апреля 2027." %}

  Вместо него используйте [POST v1/businesses/{businessId}/orders](https://yandex.ru/dev/market/partner-api/doc/ru/reference/orders/getBusinessOrders.md).

  {% endnote %}
  <!-- endsource: ru/_auto/method_scopes/getOrders.md -->
  ...
  Маркет отправит вам [запрос](https://yandex.ru/dev/market/partner-api/doc/ru/push-notifications/reference/sendNotification.md), когда появится новый заказ или изменится его статус. А полную информацию можно получить с помощью метода [POST v1/businesses/{businessId}/orders](https://yandex.ru/dev/market/partner-api/doc/ru/reference/orders/getBusinessOrders.md).
  ...
  * [POST v2/campaigns/{campaignId}/stats/orders](https://yandex.ru/dev/market/partner-api/doc/ru/reference/orders-stats/getOrdersStats.md).
  ...
  <!-- source: ru/_auto/method_limits/getOrders.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 10 000 запросов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/getOrders.md -->
  ...
  **Type**: integer
  ...
  _onlyEstimatedDelivery_{.json-schema-reset .json-schema-property}
  {.table-cell}|
  **Type**: boolean
  ...
  * `false` — фильтрация не применяется.
  ...
  _onlyWaitingForCancellationApprove_{.json-schema-reset .json-schema-property}
  {.table-cell}|
  **Type**: boolean
  ...
  **Только для модели DBS**
  ...
  Чтобы подтвердить или отклонить отмену, отправьте запрос [PUT v2/campaigns/{campaignId}/orders/{orderId}/cancellation/accept](https://yandex.ru/dev/market/partner-api/doc/ru/reference/orders/acceptOrderCancellation.md).
  ...
  **Type**: integer[]
  ...
  _page_{.json-schema-reset .json-schema-property .json-schema-deprecated}_[ ](*Deprecated)_{.openapi-deprecated .openapi-deprecated-compact}
  {.table-cell}|
  **Type**: integer
  ...
  [Подробнее о типах пагинации и их использовании](https://yandex.ru/dev/market/partner-api/doc/ru/concepts/pagination.md)
  ...
  _pageSize_{.json-schema-reset .json-schema-property .json-schema-deprecated}_[ ](*Deprecated)_{.openapi-deprecated .openapi-deprecated-compact}
  {.table-cell}|
  **Type**: integer
  ...
  * `RESERVATION_FAILED` — Маркет не может продолжить дальнейшую обработку заказа.
  ...
  _supplierShipmentDateFrom_{.json-schema-reset .json-schema-property}
  {.table-cell}|
  **Type**: string&lt;date&gt;
  ...
  _supplierShipmentDateTo_{.json-schema-reset .json-schema-property}
  {.table-cell}|
  **Type**: string&lt;date&gt;
  ...
  **Type**: string&lt;date&gt;
  ...
  _updatedAtFrom_{.json-schema-reset .json-schema-property}
  {.table-cell}|
  **Type**: string&lt;date-time&gt;
  ...
  _updatedAtTo_{.json-schema-reset .json-schema-property}
  {.table-cell}|
  **Type**: string&lt;date-time&gt;
  ...
  **Type**: [OrderDTO](#entity-OrderDTO)[]
  ...
  _pager_{.json-schema-reset .json-schema-property}
  {.table-cell}|
  **Type**: [FlippingPagerDTO](#entity-FlippingPagerDTO)
  ...
  **Type**: [PackagingForwardScrollingPagerDTO](#entity-PackagingForwardScrollingPagerDTO)
  ...
  ### FlippingPagerDTO {#entity-FlippingPagerDTO}
  ...
  _currentPage_{.json-schema-reset .json-schema-property}
  {.table-cell}|
  **Type**: integer
  ...
  **Type**: integer
  ...
  _pagesCount_{.json-schema-reset .json-schema-property}
  {.table-cell}|
  **Type**: integer
  ...
  searchParams:
    ...
    - description: >
      ...
      schema:
        ...
        items:
          $ref: >-
            /home/sandbox/.ya/build/build_root/4tup/00000b/market/mbi/docs/partner-api/docfiles/__docsbuild/.tmp_input/ru/openapi/partner-api-spec/orders/schemas.yaml#/OrderStatusType
    - description: >
      ...
      schema:
        ...
        items:
          $ref: >-
            /home/sandbox/.ya/build/build_root/4tup/00000b/market/mbi/docs/partner-api/docfiles/__docsbuild/.tmp_input/ru/openapi/partner-api-spec/orders/schemas.yaml#/OrderSubstatusType
    - description: >
        Начальная дата для фильтрации заказов по дате оформления.
    ...
    - description: Способ отгрузки
      ...
      schema:
        $ref: >-
          /home/sandbox/.ya/build/build_root/4tup/00000b/market/mbi/docs/partner-api/docfiles/__docsbuild/.tmp_input/ru/openapi/partner-api-spec/orders/schemas.yaml#/OrderDeliveryDispatchType
    - description: |
        Фильтрация заказов по типам:
    ...
    - description: >
        ...
        [«ASL BELGISI»](https://aslbelgisi.uz) (для продавцов Market
        Yandex Go):
    ...
    - description: |
      ...
      schema:
        $ref: >-
          /home/sandbox/.ya/build/build_root/4tup/00000b/market/mbi/docs/partner-api/docfiles/__docsbuild/.tmp_input/ru/openapi/partner-api-spec/orders/schemas.yaml#/OrderBuyerType
    - name: page
      description: >
        {% note warning "Параметр устарел и будет отключен 05.10.2026." %}
...
<!-- endsource: ru/api/orders/getOrders.md -->
