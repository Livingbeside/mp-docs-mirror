...
fetched_at: "2026-09-22T02:27:09Z"
content_sha: 7c2189a414f48cf3
---
...
<!-- source: ru/api/orders/provideOrderDigitalCodes.md -->
<div class="openapi">
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/provideOrderDigitalCodes.md -->
  ...
  * all-methods — Полное управление кабинетом
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/provideOrderDigitalCodes.md -->
  ...
  Подключите API-уведомления — Маркет отправит вам запрос [POST notification](https://yandex.ru/dev/market/partner-api/doc/ru/push-notifications/reference/sendNotification.md), когда заказ перейдет в статус `DELIVERED`.
  ...
  <!-- source: ru/_auto/method_limits/provideOrderDigitalCodes.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 10 000 запросов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/provideOrderDigitalCodes.md -->
  ...
  **Type**: integer
  ...
  {.table-cell}|
  **Type**: [OrderDigitalItemDTO](#entity-OrderDigitalItemDTO)[]
  ...
  ### OrderDigitalItemDTO {#entity-OrderDigitalItemDTO}
  ...
  _activate_till_{.json-schema-reset .json-schema-property .json-schema-required}
  {.table-cell}|
  **Type**: string&lt;date&gt;
  ...
  **Type**: integer
  ...
  _slip_{.json-schema-reset .json-schema-property .json-schema-required}
  {.table-cell}|
  **Type**: string
  ...
  * \<div> — поддерживается, но не влияет на отображение текста.
  ...
  _Max length:_{.json-schema-reset .json-schema-assertion} `10000`
  ...
  _codes_{.json-schema-reset .json-schema-property}
  {.table-cell}|
  **Type**: string[] &#124; null
  ...
  Статус заказа можно узнать с помощью метода [POST v1/businesses/{businessId}/orders](https://yandex.ru/dev/market/partner-api/doc/ru/reference/orders/getBusinessOrders.md).
    ...
    properties:
      items:
        description: >
          ...
          Для товара с одинаковым `id` передавайте один элемент и массив `codes`
          ...
          properties:
            ...
            slip:
              description: >
                ...
                * \<li> — для создания элементов списка (должен находиться внутри
                \<ol> или \<ul>);
            ...
            activate_till:
              description: >
                Дата, до которой нужно активировать ключи. Если ключи действуют
                бессрочно, укажите любую дату в отдаленном будущем.
...
<!-- endsource: ru/api/orders/provideOrderDigitalCodes.md -->
