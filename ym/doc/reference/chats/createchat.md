...
fetched_at: "2026-09-24T02:14:52Z"
content_sha: 64b429a091b4d0f4
---
...
<!-- source: ru/api/chats/createChat.md -->
<div class="openapi">
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/createChat.md -->
  ...
  * all-methods — Полное управление кабинетом
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/createChat.md -->
  ...
  * по возвратам (доступны только для FBY-, FBS- и Экспресс-магазинов).
  ...
  <!-- source: ru/_auto/method_limits/createChat.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 1 000 запросов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/createChat.md -->
  ...
  **Type**: integer
  ...
  _context_{.json-schema-reset .json-schema-property}
  {.table-cell}|
  **Type**: [ChatContextDTO](#entity-ChatContextDTO)
  ...
  **Type**: object
  ...
  - {% cut "**Type**: object" %}
    ...
    {.table-cell}|
    **Type**: [CreateChatResultDTO](#entity-CreateChatResultDTO)
  ...
  * `ERROR` — при обработке запроса произошла ошибка.
  ...
  ### CreateChatResultDTO {#entity-CreateChatResultDTO}
          ...
          type:
            description: >
              ...
              * `RETURN` — по возвратам (FBY, FBS и Экспресс).
              ...
              Подробнее о чатах по заказам и возвратам читайте в [Справке Маркета
              для
...
<!-- endsource: ru/api/chats/createChat.md -->
