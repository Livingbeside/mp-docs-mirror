...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/sendMessageToChat.md -->
  ...
  * all-methods — Полное управление кабинетом
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/sendMessageToChat.md -->
  
  Отправляет сообщение в чат с покупателем.
  
  <!-- source: ru/_auto/method_limits/sendMessageToChat.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 1 000 запросов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/sendMessageToChat.md -->
...
<!-- endsource: ru/api/chats/sendMessageToChat.md -->
