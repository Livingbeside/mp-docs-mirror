...
fetched_at: "2026-09-26T02:07:35Z"
content_sha: eb5bd64e9f0642ca
---
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/updateOutlet.md -->
  ...
  * all-methods — Полное управление кабинетом
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/updateOutlet.md -->
  
  Изменяет информацию о точке продаж магазина на Маркете.
  
  <!-- source: ru/_auto/method_limits/updateOutlet.md -->
  ...
  |-|
  <!-- endsource: ru/_auto/method_limits/updateOutlet.md -->
      ...
      - description: Информация о точке продаж.
        ...
        properties:
          ...
          storagePeriod:
            ...
            format: int64
    $defs:
      /home/sandbox/.ya/build/build_root/m8ef/00000b/market/mbi/docs/partner-api/docfiles/__docsbuild/.tmp_input/ru/openapi/partner-api-spec/common/schemas.yaml#/DayOfWeekType:
        description: |
          День недели:
...
<!-- endsource: ru/api/outlets/updateOutlet.md -->
