...
fetched_at: "2026-08-28T11:52:38Z"
content_sha: 4cd814761ad92d91
---
...
alternate:
  ...
  - https://yandex.ru/dev/market/partner-api/doc/zh/reference/outlets/deleteOutlet.md
  - href: ru/reference/outlets/deleteOutlet.md
    type: text/markdown
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/deleteOutlet.md -->
  ...
  * all-methods — Полное управление кабинетом
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/deleteOutlet.md -->
  
  Удаляет точку продаж магазина на Маркете.
  
  <!-- source: ru/_auto/method_limits/deleteOutlet.md -->
  ...
  |-|
  <!-- endsource: ru/_auto/method_limits/deleteOutlet.md -->
...
<!-- endsource: ru/api/outlets/deleteOutlet.md -->
