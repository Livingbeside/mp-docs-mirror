...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/getOrderBusinessBuyerInfo.md -->
  ...
  * all-methods:read-only — Просмотр всех данных
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/getOrderBusinessBuyerInfo.md -->
  
  Возвращает информацию о покупателе по идентификатору заказа.
  
  {% note info "Как получить информацию о покупателе, который является физическим лицом" %}
  
  Воспользуйтесь запросом [GET v2/campaigns/{campaignId}/orders/{orderId}/buyer](https://yandex.ru/dev/market/partner-api/doc/ru/reference/order-delivery/getOrderBuyerInfo.md).
  
  {% endnote %}
  
  Получить данные можно, только если заказ находится в статусе `PROCESSING`, `DELIVERY`, `PICKUP` или `DELIVERED`.
  
  <!-- source: ru/_auto/method_limits/getOrderBusinessBuyerInfo.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 3 000 запросов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/getOrderBusinessBuyerInfo.md -->
  ...
  **Type**: integer
  ...
  ```json translate=no
  {
    ...
    "result": {
      ...
      "organizationJurAddress": "example"
    }
  }
  ```
  ...
  **Type**: object
  ...
  - {% cut "**Type**: object" %}
    ...
    {.table-cell}|
    **Type**: [OrderBusinessBuyerDTO](#entity-OrderBusinessBuyerDTO)
  ...
  * `ERROR` — при обработке запроса произошла ошибка.
  ...
  ### OrderBusinessBuyerDTO {#entity-OrderBusinessBuyerDTO}
  ...
  _inn_{.json-schema-reset .json-schema-property}
  {.table-cell}|
  **Type**: string
  ...
  _kpp_{.json-schema-reset .json-schema-property}
  {.table-cell}|
  **Type**: string
  ...
  _organizationJurAddress_{.json-schema-reset .json-schema-property}
  {.table-cell}|
  **Type**: string
  ...
  _organizationName_{.json-schema-reset .json-schema-property}
  {.table-cell}|
  **Type**: string
...
<!-- endsource: ru/api/order-business-information/getOrderBusinessBuyerInfo.md -->
