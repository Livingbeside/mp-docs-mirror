...
fetched_at: "2026-08-28T11:52:28Z"
content_sha: f88471d426afdb64
---
...
alternate:
  ...
  - https://yandex.ru/dev/market/partner-api/doc/zh/reference/shipments/downloadShipmentAct.md
  - href: ru/reference/shipments/downloadShipmentAct.md
    type: text/markdown
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/downloadShipmentAct.md -->
  ...
  * all-methods — Полное управление кабинетом
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/downloadShipmentAct.md -->
  ...
  Метод доступен только для подтвержденной отгрузки. Сначала подтвердите отгрузку запросом [POST v2/campaigns/{campaignId}/shipments/{shipmentId}/confirm](https://yandex.ru/dev/market/partner-api/doc/ru/reference/shipments/confirmShipment.md), затем вызовите этот метод.
  ...
  <!-- source: ru/_auto/method_limits/downloadShipmentAct.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 200 запросов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/downloadShipmentAct.md -->
...
<!-- endsource: ru/api/shipments/downloadShipmentAct.md -->
