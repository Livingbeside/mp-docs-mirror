...
fetched_at: "2026-08-28T11:52:29Z"
content_sha: f109a1609b0b50cf
---
...
<!-- source: ru/api/shipments/downloadShipmentDiscrepancyAct.md -->
<div class="openapi">
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/downloadShipmentDiscrepancyAct.md -->
  ...
  * all-methods — Полное управление кабинетом
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/downloadShipmentDiscrepancyAct.md -->
  
  Возвращает акт расхождений для заданной отгрузки.
  
  <!-- source: ru/_auto/method_limits/downloadShipmentDiscrepancyAct.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 200 запросов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/downloadShipmentDiscrepancyAct.md -->
...
<!-- endsource: ru/api/shipments/downloadShipmentDiscrepancyAct.md -->
