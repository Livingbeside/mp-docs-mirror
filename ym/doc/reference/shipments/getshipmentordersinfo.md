...
fetched_at: "2026-08-28T11:52:33Z"
content_sha: 1342b5d3643ea2c5
---
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/getShipmentOrdersInfo.md -->
  ...
  * all-methods:read-only — Просмотр всех данных
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/getShipmentOrdersInfo.md -->
  
  Возвращает информацию о возможности печати ярлыков-наклеек для заказов в отгрузке.
  
  <!-- source: ru/_auto/method_limits/getShipmentOrdersInfo.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 200 запросов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/getShipmentOrdersInfo.md -->
  ...
  **Type**: object
  ...
  - {% cut "**Type**: object" %}
    ...
    {.table-cell}|
    **Type**: [OrdersShipmentInfoDTO](#entity-OrdersShipmentInfoDTO)
  ...
  * `ERROR` — при обработке запроса произошла ошибка.
  ...
  ### OrdersShipmentInfoDTO {#entity-OrdersShipmentInfoDTO}
  ...
  _orderIdsWithLabels_{.json-schema-reset .json-schema-property .json-schema-required}
  {.table-cell}|
  **Type**: integer[]
  ...
  _orderIdsWithoutLabels_{.json-schema-reset .json-schema-property .json-schema-required}
  {.table-cell}|
  **Type**: integer[]
...
<!-- endsource: ru/api/shipments/getShipmentOrdersInfo.md -->
