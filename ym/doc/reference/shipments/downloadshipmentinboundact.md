...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/downloadShipmentInboundAct.md -->
  ...
  * all-methods — Полное управление кабинетом
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/downloadShipmentInboundAct.md -->
  ...
  <!-- source: ru/_auto/method_limits/downloadShipmentInboundAct.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 200 запросов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/downloadShipmentInboundAct.md -->
...
<!-- endsource: ru/api/shipments/downloadShipmentInboundAct.md -->
