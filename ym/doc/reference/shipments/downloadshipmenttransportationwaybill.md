...
alternate:
  ...
  - https://yandex.ru/dev/market/partner-api/doc/zh/reference/shipments/downloadShipmentTransportationWaybill.md
  - href: https://yandex.ru/dev/market/partner-api/doc/ru/reference/shipments/downloadShipmentTransportationWaybill.md
    type: text/markdown
...
<!-- source: ru/api/shipments/downloadShipmentTransportationWaybill.md -->
<div class="openapi">
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/downloadShipmentTransportationWaybill.md -->
  ...
  * all-methods — Полное управление кабинетом
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/downloadShipmentTransportationWaybill.md -->
  ...
  <!-- source: ru/_auto/method_limits/downloadShipmentTransportationWaybill.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 200 запросов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/downloadShipmentTransportationWaybill.md -->
...
- Console
  ...
  path: >-
    v2/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/transportation-waybill
...
<!-- endsource: ru/api/shipments/downloadShipmentTransportationWaybill.md -->
