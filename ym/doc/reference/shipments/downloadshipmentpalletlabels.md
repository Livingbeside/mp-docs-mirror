...
fetched_at: "2026-09-25T02:17:32Z"
content_sha: 3d5e6fa70b023a83
---
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/downloadShipmentPalletLabels.md -->
  ...
  * all-methods — Полное управление кабинетом
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/downloadShipmentPalletLabels.md -->
  ...
  Количество упаковок в отгрузке передается в методе [PUT v2/campaigns/{campaignId}/first-mile/shipments/{shipmentId}/pallets](https://yandex.ru/dev/market/partner-api/doc/ru/reference/shipments/setShipmentPalletsCount.md).
  
  <!-- source: ru/_auto/method_limits/downloadShipmentPalletLabels.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 200 запросов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/downloadShipmentPalletLabels.md -->
  ...
  **Type**: integer
  ...
  {.table-cell}|
  **Type**: [ShipmentPalletLabelPageFormatType](#entity-ShipmentPalletLabelPageFormatType)
  ...
  * `A8` — формат страницы A8.
  ...
  _Default:_{.json-schema-reset .json-schema-value} `A8`
  
  _Enum:_{.json-schema-reset .json-schema-value} `A4`, `A8`
  {.table-cell}
  ||
  |#{.json-schema-properties}
  ...
  ### ShipmentPalletLabelPageFormatType {#entity-ShipmentPalletLabelPageFormatType}
...
- Console
  ...
  searchParams:
    - name: format
      ...
      schema:
        $ref: >-
          /home/sandbox/.ya/build/build_root/fti6/00000b/market/mbi/docs/partner-api/docfiles/__docsbuild/.tmp_input/ru/openapi/partner-api-spec/shipments/schemas.yaml#/ShipmentPalletLabelPageFormatType
      description: |
        Формат страниц PDF-файла с ярлыками:
...
<!-- endsource: ru/api/shipments/downloadShipmentPalletLabels.md -->
