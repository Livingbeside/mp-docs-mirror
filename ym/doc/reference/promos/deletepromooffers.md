...
fetched_at: "2026-08-28T11:52:09Z"
content_sha: dc654619a5c92002
---
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/deletePromoOffers.md -->
  ...
  * all-methods — Полное управление кабинетом
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/deletePromoOffers.md -->
  ...
  <!-- source: ru/_auto/method_limits/deletePromoOffers.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 5 000 запросов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/deletePromoOffers.md -->
  ...
  **Type**: string
  ...
  _deleteAllOffers_{.json-schema-reset .json-schema-property}
  {.table-cell}|
  **Type**: boolean
  ...
  **Type**: object
  ...
  - {% cut "**Type**: object" %}
    ...
    {.table-cell}|
    **Type**: [DeletePromoOffersResultDTO](#entity-DeletePromoOffersResultDTO)
  ...
  * `ERROR` — при обработке запроса произошла ошибка.
  ...
  ### RejectedPromoOfferDeleteReasonType {#entity-RejectedPromoOfferDeleteReasonType}
  ...
  **Type**: string
  ...
  _Const:_{.json-schema-reset .json-schema-value} `OFFER_DOES_NOT_EXIST`
  ...
  ### RejectedPromoOfferDeleteDTO {#entity-RejectedPromoOfferDeleteDTO}
  ...
  * Уже заданный SKU нельзя освободить и использовать заново для другого товара. Каждый товар должен получать новый идентификатор, до того никогда не использовавшийся в вашем каталоге.
  ...
  {.table-cell}|
  **Type**: [RejectedPromoOfferDeleteReasonType](#entity-RejectedPromoOfferDeleteReasonType)
  ...
  * `OFFER_DOES_NOT_EXIST` — в кабинете нет товара с таким SKU.
  ...
  ### DeletePromoOffersResultDTO {#entity-DeletePromoOffersResultDTO}
  ...
  {.table-cell}|
  **Type**: [RejectedPromoOfferDeleteDTO](#entity-RejectedPromoOfferDeleteDTO)[] &#124; null
...
- Console
  ...
  schema:
    description: >
      ...
      * все товары из акции и больше не участвовать в ней, передайте значение
      `true` в параметре `deleteAllOffers`;
    ...
    properties:
      ...
      deleteAllOffers:
        description: >-
          Чтобы убрать все товары из акции и больше не участвовать в ней,
          передайте значение `true` и не передавайте параметр `offerIds`.
        type: boolean
      offerIds:
...
<!-- endsource: ru/api/promos/deletePromoOffers.md -->
