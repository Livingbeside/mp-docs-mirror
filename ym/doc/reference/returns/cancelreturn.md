...
fetched_at: "2026-09-24T02:14:23Z"
content_sha: f8674e0b9f67d433
---
...
<!-- source: ru/api/returns/cancelReturn.md -->
<div class="openapi">
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/cancelReturn.md -->
  ...
  * all-methods — Полное управление кабинетом
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/cancelReturn.md -->
  ...
  Отмена возврата применяется в течение нескольких минут и только в случае успешного завершения операции. [Как проверить статус операции](https://yandex.ru/dev/market/partner-api/doc/ru/reference/operations/getOperations.md)
  ...
  <!-- source: ru/_auto/method_limits/cancelReturn.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 5 000 запросов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/cancelReturn.md -->
  ...
  ```text translate=no
  https://api.partner.market.yandex.ru/v1/campaigns/{campaignId}/returns/cancel
  ```
  ...
  **Type**: integer
  ...
  Информация об операции по отмене возврата.
  ...
  **Type**: object
  ...
  - {% cut "**Type**: object" %}
    ...
    {.table-cell}|
    **Type**: [CancelReturnDTO](#entity-CancelReturnDTO)
  ...
  * `RETURN_CANCELLATION` — отмена возврата.
  ...
  ### CancelReturnDTO {#entity-CancelReturnDTO}
  ...
  **Type**: [OperationDTO](#entity-OperationDTO)
  ...
  Запущенная операция отмены возврата.
...
<!-- endsource: ru/api/returns/cancelReturn.md -->
