...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/getReturn.md -->
  ...
  * all-methods:read-only — Просмотр всех данных
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/getReturn.md -->
  ...
  <!-- source: ru/_auto/method_limits/getReturn.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 7 000 запросов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/getReturn.md -->
...
<!-- endsource: ru/api/returns/getReturn.md -->
