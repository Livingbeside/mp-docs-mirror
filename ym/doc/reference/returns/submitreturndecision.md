...
fetched_at: "2026-08-28T11:52:43Z"
content_sha: 23bca39ab739b102
---
...
alternate:
  ...
  - https://yandex.ru/dev/market/partner-api/doc/zh/reference/returns/submitReturnDecision.md
  - href: ru/reference/returns/submitReturnDecision.md
    type: text/markdown
...
<!-- source: ru/api/returns/submitReturnDecision.md -->
<div class="openapi">
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/submitReturnDecision.md -->
  ...
  * all-methods — Полное управление кабинетом
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/submitReturnDecision.md -->
  
  Позволяет передать список решений по возврату.
  
  {% note info "Перед вызовом метода" %}
  
  Получите список доступных решений — [POST v1/businesses/{businessId}/returns/decisions](https://yandex.ru/dev/market/partner-api/doc/ru/reference/returns/getReturnAvailableDecisions.md).
  
  {% endnote %}
  
  <!-- source: ru/_auto/method_limits/submitReturnDecision.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 5 000 запросов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/submitReturnDecision.md -->
  ...
  **Type**: integer
  ...
  _returnItemDecisions_{.json-schema-reset .json-schema-property .json-schema-required}
  {.table-cell}|
  **Type**: [ReturnItemDecisionDTO](#entity-ReturnItemDecisionDTO)[]
  ...
  **Type**: number
  ...
  ### ReturnItemDecisionDTO {#entity-ReturnItemDecisionDTO}
  ...
  **Type**: [BasePriceDTO](#entity-BasePriceDTO)
  ...
  _decisionReasonType_{.json-schema-reset .json-schema-property}
  {.table-cell}|
  **Type**: [ReturnRequestDecisionReasonType](#entity-ReturnRequestDecisionReasonType)
...
- Console
  ...
  schema:
        ...
        items:
          ...
          properties:
            ...
            decisionReasonType:
              ...
              $ref: '#/$defs/ReturnRequestDecisionReasonType'
            comment:
              description: >
                Комментарий к решению. Укажите:
  
  
                * для `REFUND_MONEY_INCLUDING_SHIPMENT`— стоимость обратной
                пересылки.
    ...
    $defs:
      /home/sandbox/.ya/build/build_root/guyl/00000b/market/mbi/docs/partner-api/docfiles/__docsbuild/.tmp_input/ru/openapi/partner-api-spec/returns/schemas.yaml#/ReturnRequestDecisionType:
        description: >
          Решение по возврату:
        ...
        enum:
          ...
          - OTHER_DECISION
      /home/sandbox/.ya/build/build_root/guyl/00000b/market/mbi/docs/partner-api/docfiles/__docsbuild/.tmp_input/ru/openapi/partner-api-spec/returns/schemas.yaml#/ReturnRequestDecisionReasonType:
        description: >
          Причина отказа:
  
  
          * `ISSUE_WITH_THE_PRODUCT_WAS_NOT_CONFIRMED` — проблема с товаром не
          подтвердилась.
          ...
          * `CONFIGURATION_OR_PACKAGING_COMPROMISED` — нарушена комплектация или
          упаковка.
...
<!-- endsource: ru/api/returns/submitReturnDecision.md -->
