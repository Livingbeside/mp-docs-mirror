...
fetched_at: "2026-09-24T02:14:55Z"
content_sha: a461ab45d641b419
---
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/getAuthTokenInfo.md -->
  ...
  * all-methods:read-only — Просмотр всех данных
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/getAuthTokenInfo.md -->
  ...
  <!-- source: ru/_auto/method_limits/getAuthTokenInfo.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 100 запросов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/getAuthTokenInfo.md -->
  ...
  * `ERROR` — при обработке запроса произошла ошибка.
  ...
  ### ApiKeyScopeType {#entity-ApiKeyScopeType}
  ...
  **Type**: string
  ...
  _authScopes_{.json-schema-reset .json-schema-property .json-schema-required}
  {.table-cell}|
  **Type**: [ApiKeyScopeType](#entity-ApiKeyScopeType)[]
  ...
  **Type**: string
  ...
  _apiKey_{.json-schema-reset .json-schema-property .json-schema-required}
  {.table-cell}|
  **Type**: [ApiKeyDTO](#entity-ApiKeyDTO)
...
<!-- endsource: ru/api/auth/getAuthTokenInfo.md -->
