...
fetched_at: "2026-09-22T02:27:47Z"
content_sha: 06d6432b3b2a53d3
---
...
alternate:
  ...
  - https://yandex.ru/dev/market/partner-api/doc/zh/reference/goods-feedback/skipGoodsFeedbacksReaction.md
  - href: https://yandex.ru/dev/market/partner-api/doc/ru/reference/goods-feedback/skipGoodsFeedbacksReaction.md
    type: text/markdown
...
<!-- source: ru/api/goods-feedback/skipGoodsFeedbacksReaction.md -->
<div class="openapi">
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/skipGoodsFeedbacksReaction.md -->
  ...
  * all-methods — Полное управление кабинетом
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/skipGoodsFeedbacksReaction.md -->
  
  Пропускает реакцию на отзыв — параметр `needReaction` принимает значение `false` в методе получения всех отзывов [POST v2/businesses/{businessId}/goods-feedback](https://yandex.ru/dev/market/partner-api/doc/ru/reference/goods-feedback/getGoodsFeedbacks.md).
  
  <!-- source: ru/_auto/method_limits/skipGoodsFeedbacksReaction.md -->
  ...
  |-|
  <!-- endsource: ru/_auto/method_limits/skipGoodsFeedbacksReaction.md -->
  ...
  **Type**: string
  ...
  _feedbackIds_{.json-schema-reset .json-schema-property .json-schema-required}
  {.table-cell}|
...
<!-- endsource: ru/api/goods-feedback/skipGoodsFeedbacksReaction.md -->
