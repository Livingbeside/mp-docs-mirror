...
fetched_at: "2026-09-10T01:57:14Z"
content_sha: 768b4958366c732b
---
...
alternate:
  - https://yandex.ru/dev/market/partner-api/doc/en/reference/goods-feedback/deleteGoodsFeedbackComment.md
  - https://yandex.ru/dev/market/partner-api/doc/ru/reference/goods-feedback/deleteGoodsFeedbackComment.md
  - https://yandex.ru/dev/market/partner-api/doc/zh/reference/goods-feedback/deleteGoodsFeedbackComment.md
  - href: ru/reference/goods-feedback/deleteGoodsFeedbackComment.md
    type: text/markdown
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/deleteGoodsFeedbackComment.md -->
  ...
  * all-methods — Полное управление кабинетом
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/deleteGoodsFeedbackComment.md -->
  
  Удаляет комментарий магазина.
  
  <!-- source: ru/_auto/method_limits/deleteGoodsFeedbackComment.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 1 000 запросов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/deleteGoodsFeedbackComment.md -->
...
<!-- endsource: ru/api/goods-feedback/deleteGoodsFeedbackComment.md -->
