...
fetched_at: "2026-08-28T11:51:46Z"
content_sha: 7542ccefe7dff1b5
---
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/getCampaigns.md -->
  ...
  * all-methods:read-only — Просмотр всех данных
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/getCampaigns.md -->
  ...
  **Для OAuth-токена:** возвращает список магазинов, к которым имеет доступ пользователь — владелец токена авторизации, использованного в запросе. Для агентских пользователей список состоит из подагентских магазинов.
  ...
  <!-- source: ru/_auto/method_limits/getCampaigns.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 1 000 запросов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/getCampaigns.md -->
  ...
  **Type**: string
  ...
  _campaigns_{.json-schema-reset .json-schema-property .json-schema-required}
  {.table-cell}|
...
<!-- endsource: ru/api/campaigns/getCampaigns.md -->
