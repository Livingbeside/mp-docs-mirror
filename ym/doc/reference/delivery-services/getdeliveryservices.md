...
<!-- source: ru/api/delivery-services/getDeliveryServices.md -->
<div class="openapi">
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/getDeliveryServices.md -->
  ...
  * all-methods:read-only — Просмотр всех данных
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/getDeliveryServices.md -->
  
  Возвращает справочник служб доставки: идентификаторы и наименования.
  
  <!-- source: ru/_auto/method_limits/getDeliveryServices.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 5 000 запросов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/getDeliveryServices.md -->
  ...
  {.table-cell}|
  **Type**: [DeliveryServicesDTO](#entity-DeliveryServicesDTO)
  ...
  ### DeliveryServiceInfoDTO {#entity-DeliveryServiceInfoDTO}
  ...
  **Type**: string
  ...
  ### DeliveryServicesDTO {#entity-DeliveryServicesDTO}
  ...
  _deliveryService_{.json-schema-reset .json-schema-property .json-schema-required}
  {.table-cell}|
  **Type**: [DeliveryServiceInfoDTO](#entity-DeliveryServiceInfoDTO)[]
...
<!-- endsource: ru/api/delivery-services/getDeliveryServices.md -->
