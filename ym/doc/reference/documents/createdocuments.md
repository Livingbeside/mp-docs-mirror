...
alternate:
  ...
  - https://yandex.ru/dev/market/partner-api/doc/zh/reference/documents/createDocuments.md
  - href: https://yandex.ru/dev/market/partner-api/doc/ru/reference/documents/createDocuments.md
    type: text/markdown
...
<!-- source: ru/api/documents/createDocuments.md -->
<div class="openapi">
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/createDocuments.md -->
  ...
  * all-methods — Полное управление кабинетом
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/createDocuments.md -->
  ...
  <!-- source: ru/_auto/method_limits/createDocuments.md -->
  ...
  |-|
  <!-- endsource: ru/_auto/method_limits/createDocuments.md -->
  ...
  **Type**: [DocumentWriteDTO](#entity-DocumentWriteDTO)[]
  ...
  Документы для создания. Номера документов не должны повторяться в одном запросе.
  Если номера повторяются, запрос не обрабатывается.
  ...
  **Type**: object
  ...
  - {% cut "**Type**: object" %}
    ...
    {.table-cell}|
    **Type**: [CreateDocumentsResultDTO](#entity-CreateDocumentsResultDTO)
  ...
  **Type**: string
  ...
  ### CreateDocumentErrorDTO {#entity-CreateDocumentErrorDTO}
  ...
  **Type**: string
  ...
  ### CreateDocumentsResultDTO {#entity-CreateDocumentsResultDTO}
  ...
  _documents_{.json-schema-reset .json-schema-property}
  {.table-cell}|
  **Type**: [BusinessDocumentDTO](#entity-BusinessDocumentDTO)[] &#124; null
  
  Документы, созданные этим запросом.
  ...
  {.table-cell}|
  **Type**: [CreateDocumentErrorDTO](#entity-CreateDocumentErrorDTO)[] &#124; null
  
  Ошибки документов, которые не удалось создать.
...
- Console
  ...
  schema:
    type: object
    description: Документы для создания.
    required:
      - documents
    properties:
      documents:
        ...
        maxItems: 100
        description: >
          Документы для создания. Номера документов не должны повторяться в одном
          запросе.
...
<!-- endsource: ru/api/documents/createDocuments.md -->
