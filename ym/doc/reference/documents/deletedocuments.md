...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/deleteDocuments.md -->
  ...
  * all-methods — Полное управление кабинетом
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/deleteDocuments.md -->
  ...
  <!-- source: ru/_auto/method_limits/deleteDocuments.md -->
  ...
  |-|
  <!-- endsource: ru/_auto/method_limits/deleteDocuments.md -->
  ...
  ```text translate=no
  https://api.partner.market.yandex.ru/v1/businesses/{businessId}/offers/documents/delete
  ```
  ...
  **Type**: integer
  ...
  _documentIds_{.json-schema-reset .json-schema-property .json-schema-required}
  {.table-cell}|
  **Type**: [DocumentId](#entity-DocumentId)[]
  
  Идентификаторы документов. Значения не должны повторяться.
  ...
  **Type**: integer
  ...
  Документы отсутствуют после обработки запроса.
...
- Console
  ...
  schema:
    type: object
    description: Документы для удаления.
    required:
      - documentIds
    properties:
      documentIds:
...
<!-- endsource: ru/api/documents/deleteDocuments.md -->
