...
<!-- source: ru/api/business-offer-mappings/deleteOffersFromArchive.md -->
<div class="openapi">
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/deleteOffersFromArchive.md -->
  ...
  * all-methods — Полное управление кабинетом
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/deleteOffersFromArchive.md -->
  
  Восстанавливает товары из архива.
  
  <!-- source: ru/_auto/method_limits/deleteOffersFromArchive.md -->
  ...
  |-|
  <!-- endsource: ru/_auto/method_limits/deleteOffersFromArchive.md -->
  ...
  **Type**: object
  ...
  - {% cut "**Type**: object" %}
    ...
    {.table-cell}|
    **Type**: [DeleteOffersFromArchiveDTO](#entity-DeleteOffersFromArchiveDTO)
  ...
  * `ERROR` — при обработке запроса произошла ошибка.
  ...
  ### DeleteOffersFromArchiveDTO {#entity-DeleteOffersFromArchiveDTO}
  ...
  _notUnarchivedOfferIds_{.json-schema-reset .json-schema-property}
  {.table-cell}|
...
<!-- endsource: ru/api/business-offer-mappings/deleteOffersFromArchive.md -->
