...
fetched_at: "2026-09-24T02:13:36Z"
content_sha: 12d51093d4f8d570
---
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/generateOfferBarcodes.md -->
  ...
  * all-methods — Полное управление кабинетом
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/generateOfferBarcodes.md -->
  
  Генерирует штрихкоды и присваивает их указанным товарам.
  
  Если у товара на упаковке уже есть штрихкод производителя, передайте его в параметре `barcodes` в методе [POST v2/businesses/{businessId}/offer-mappings/update](https://yandex.ru/dev/market/partner-api/doc/ru/reference/business-offer-mappings/updateOfferMappings.md). Генерировать новый не нужно.
  
  <!-- source: ru/_auto/method_limits/generateOfferBarcodes.md -->
  ...
  |-|
  <!-- endsource: ru/_auto/method_limits/generateOfferBarcodes.md -->
  ...
  **Type**: [ShopSku](#entity-ShopSku)[]
  ...
  _skipIfExists_{.json-schema-reset .json-schema-property}
  {.table-cell}|
  **Type**: boolean
  
  Для каких товаров нужно сгенерировать штрихкоды:
  
  * `false` — для всех, которые переданы в запросе.
  * `true` — только для тех, у которых их нет.
  ...
  **Type**: object
  ...
  - {% cut "**Type**: object" %}
    ...
    {.table-cell}|
    **Type**: [GenerateOfferBarcodesResultDTO](#entity-GenerateOfferBarcodesResultDTO)
  
    Товары, для которых не удалось сгенерировать штрихкоды.
  
    Проверьте корректность переданных `offerId`. Если ошибка повторяется, обратитесь в службу поддержки — перейдите в [кабинет продавца на Маркете](https://partner.market.yandex.ru/business/any/support) и нажмите кнопку **Создать обращение**.
  ...
  * `ERROR` — при обработке запроса произошла ошибка.
  ...
  ### GenerateOfferBarcodesResultDTO {#entity-GenerateOfferBarcodesResultDTO}
  ...
  _unprocessedOfferIds_{.json-schema-reset .json-schema-property .json-schema-required}
  {.table-cell}|
  **Type**: [ShopSku](#entity-ShopSku)[]
...
- Console
  ...
  schema:
    ...
    properties:
      offerIds:
        description: Список товаров, для которых нужно сгенерировать штрихкоды.
        type: array
        minItems: 1
        maxItems: 100
        uniqueItems: true
...
<!-- endsource: ru/api/business-offer-mappings/generateOfferBarcodes.md -->
