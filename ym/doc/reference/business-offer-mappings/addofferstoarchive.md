...
<!-- source: ru/api/business-offer-mappings/addOffersToArchive.md -->
<div class="openapi">
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/addOffersToArchive.md -->
  ...
  * all-methods — Полное управление кабинетом
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/addOffersToArchive.md -->
  ...
  <!-- source: ru/_auto/method_limits/addOffersToArchive.md -->
  ...
  |-|
  <!-- endsource: ru/_auto/method_limits/addOffersToArchive.md -->
  ...
  **Type**: object
  ...
  - {% cut "**Type**: object" %}
    ...
    {.table-cell}|
    **Type**: [AddOffersToArchiveDTO](#entity-AddOffersToArchiveDTO)
  ...
  * `ERROR` — при обработке запроса произошла ошибка.
  ...
  ### AddOffersToArchiveErrorType {#entity-AddOffersToArchiveErrorType}
  ...
  **Type**: string
  ...
  _Enum:_{.json-schema-reset .json-schema-value} `OFFER_HAS_STOCKS`, `UNKNOWN`
  
  </div>
  
  <div class="openapi-entity">
  
  ### AddOffersToArchiveErrorDTO {#entity-AddOffersToArchiveErrorDTO}
  ...
  {.table-cell}|
  **Type**: [AddOffersToArchiveErrorType](#entity-AddOffersToArchiveErrorType)
  ...
  * Уже заданный SKU нельзя освободить и использовать заново для другого товара. Каждый товар должен получать новый идентификатор, до того никогда не использовавшийся в вашем каталоге.
  ...
  ### AddOffersToArchiveDTO {#entity-AddOffersToArchiveDTO}
  ...
  _notArchivedOffers_{.json-schema-reset .json-schema-property}
  {.table-cell}|
  **Type**: [AddOffersToArchiveErrorDTO](#entity-AddOffersToArchiveErrorDTO)[] &#124; null
...
<!-- endsource: ru/api/business-offer-mappings/addOffersToArchive.md -->
