...
fetched_at: "2026-09-16T02:28:00Z"
content_sha: 94c9eba8eedfa43c
---
...
alternate:
  ...
  - https://yandex.ru/dev/market/partner-api/doc/zh/reference/reports/generateGoodsMovementReport.md
  - href: https://yandex.ru/dev/market/partner-api/doc/ru/reference/reports/generateGoodsMovementReport.md
    type: text/markdown
...
<!-- source: ru/api/reports/generateGoodsMovementReport.md -->
<div class="openapi">
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/generateGoodsMovementReport.md -->
  ...
  * all-methods:read-only — Просмотр всех данных
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/generateGoodsMovementReport.md -->
  ...
  <!-- source: ru/_auto/reports/sku/movement/movement_config.md -->
  Пояснение к колонкам отчета:

  {% cut "Лист **Отчет по движению товаров** (файл **movement_by_sku**)" %}
  ...
  {% cut "Лист **Отчет по движению товара** (файл **movement_by_type**)" %}
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/reports/sku/movement/movement_config.md -->
  ...
  * **Тариф «Медиум»** — одновременно может генерироваться до 10 отчетов
  ...
  <!-- source: ru/_auto/method_limits/generateGoodsMovementReport.md -->
  ...
  |-|
  <!-- endsource: ru/_auto/method_limits/generateGoodsMovementReport.md -->
...
<!-- endsource: ru/api/reports/generateGoodsMovementReport.md -->
