...
fetched_at: "2026-09-16T02:27:59Z"
content_sha: 17a75520ad85fddb
---
...
alternate:
  - https://yandex.ru/dev/market/partner-api/doc/en/reference/reports/generateGoodsFeedbackReport.md
  - https://yandex.ru/dev/market/partner-api/doc/ru/reference/reports/generateGoodsFeedbackReport.md
  - https://yandex.ru/dev/market/partner-api/doc/zh/reference/reports/generateGoodsFeedbackReport.md
  - href: https://yandex.ru/dev/market/partner-api/doc/ru/reference/reports/generateGoodsFeedbackReport.md
    type: text/markdown
...
<!-- source: ru/api/reports/generateGoodsFeedbackReport.md -->
<div class="openapi">
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/generateGoodsFeedbackReport.md -->
  ...
  * all-methods:read-only — Просмотр всех данных
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/generateGoodsFeedbackReport.md -->
  ...
  <!-- source: ru/_auto/reports/paid_opinion_models/paid_opinion_models.md -->
  Пояснение к колонкам отчета:

  {% cut "Лист **Товары на витрине** (файл **paid_opinion_models**)" %}
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/reports/paid_opinion_models/paid_opinion_models.md -->
  ...
  * **Тариф «Медиум»** — одновременно может генерироваться до 10 отчетов
  ...
  <!-- source: ru/_auto/method_limits/generateGoodsFeedbackReport.md -->
  ...
  |-|
  <!-- endsource: ru/_auto/method_limits/generateGoodsFeedbackReport.md -->
...
<!-- endsource: ru/api/reports/generateGoodsFeedbackReport.md -->
