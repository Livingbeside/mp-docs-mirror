...
alternate:
  - https://yandex.ru/dev/market/partner-api/doc/en/reference/reports/generateBoostConsolidatedReport.md
  - https://yandex.ru/dev/market/partner-api/doc/ru/reference/reports/generateBoostConsolidatedReport.md
  - https://yandex.ru/dev/market/partner-api/doc/zh/reference/reports/generateBoostConsolidatedReport.md
  - href: https://yandex.ru/dev/market/partner-api/doc/ru/reference/reports/generateBoostConsolidatedReport.md
    type: text/markdown
...
<!-- source: ru/api/reports/generateBoostConsolidatedReport.md -->
<div class="openapi">
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/generateBoostConsolidatedReport.md -->
  ...
  * all-methods:read-only — Просмотр всех данных
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/generateBoostConsolidatedReport.md -->
  ...
  <!-- source: ru/_auto/reports/boost/consolidated/business_boost_consolidated.md -->
  Пояснение к колонкам отчета:

  {% cut "Лист **Сводный отчет** (файл **business_boost_consolidated**)" %}
  ...
  || BILLED_AMOUNT | billedAmount | Расходы на буст,.* | number ||
  || AVERAGE_BOOST_COST | averageBoostCost | Средняя стоимость буста,.* | number ||
  || ORDERS_GVM_DELIVERED_WITH_FEE | ordersGvmDeliveredWithFee | Выручка с бустом,.* | number ||
  || ORDERS_GVM_DELIVERED | ordersGvmDelivered | Вся выручка,.* | number ||
  |#

  {% endcut %}
  <!-- endsource: ru/_auto/reports/boost/consolidated/business_boost_consolidated.md -->
  ...
  * **Тариф «Медиум»** — доступны данные за последние 400 дней, одновременно может генерироваться до 10 отчетов
  ...
  <!-- source: ru/_auto/method_limits/generateBoostConsolidatedReport.md -->
  ...
  |-|
  <!-- endsource: ru/_auto/method_limits/generateBoostConsolidatedReport.md -->
...
<!-- endsource: ru/api/reports/generateBoostConsolidatedReport.md -->
