...
source: "https://yandex.ru/dev/market/partner-api/doc/ru/reference/reports/generateBannersStatisticsReport.md"
fetched_at: "2026-09-22T02:27:44Z"
content_sha: 4cbc3c5a69ead525
---
...
alternate:
  - https://yandex.ru/dev/market/partner-api/doc/en/reference/reports/generateBannersStatisticsReport.md
  - https://yandex.ru/dev/market/partner-api/doc/ru/reference/reports/generateBannersStatisticsReport.md
  - https://yandex.ru/dev/market/partner-api/doc/zh/reference/reports/generateBannersStatisticsReport.md
  - href: https://yandex.ru/dev/market/partner-api/doc/ru/reference/reports/generateBannersStatisticsReport.md
    type: text/markdown
...
<!-- source: ru/api/reports/generateBannersStatisticsReport.md -->
<div class="openapi">
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/generateBannersStatisticsReport.md -->
  ...
  * all-methods:read-only — Просмотр всех данных
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/generateBannersStatisticsReport.md -->
  ...
  <!-- source: ru/_auto/reports/incuts/banners_statistics.md -->
  Пояснение к колонкам отчета:

  {% cut "Лист **Общий отчет** (файл **banners_statistics_report_consolidated**)" %}
  ...
  drr
  |
  Доля расчётных расходов
  от выручки с баннером, %
  |
  number
  ||
  ...
  {% cut "Лист **Таргетинг по площадкам** (файл **banners_statistics_report_by_service_type**)" %}
  ...
  {% cut "Лист **Данные по срезам** (файл **banners_statistics_report_by_slices**)" %}
  ...
  || CAMPAIGN_NAME | campaignName | Название кампании | string ||
  || SERVICE_TYPE | serviceType | Площадка | string ||
  || CREATIVE_FORMAT | creativeFormat | Формат | string ||
  || POSITION_NUMBER | positionNumber | Номер варианта | string ||
  || CREATIVE_HASH | creativeHash | Id варианта | string ||
  || CREATIVE_URL | creativeUrl | Ссылка на креатив | string ||
  || COPYRIGHT | copyright | Копирайт | string ||
  || SHOWS | shows | Показы, шт. | integer ||
  || COVERAGE | coverage | Охват, чел. | integer ||
  || CLICKS | clicks | Клики, шт. | integer ||
  || CTR | ctr | CTR, % | number ||
  ...
  || ORDERED_COUNT | orderedCount | Заказанные товары, шт. | integer ||
  || CONVERSION | conversion | Конверсия в заказы, % | number ||
  || DRR | drr | Доля расчётных расходов от выручки с кампании, % | number ||
  || ORDERED_AMOUNT | orderedAmount | Стоимость заказанных товаров(,.*)? | number ||
  || CPO | cpo | СРО(,.*)? | number ||
  || COST | cost | Расчётные расходы(,.*)? | number ||
  || CPM | cpm | CPM(,.*)? | number ||
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/reports/incuts/banners_statistics.md -->
  ...
  * **Тариф «Медиум»** — доступны данные за последние 400 дней, одновременно может генерироваться до 10 отчетов
  ...
  <!-- source: ru/_auto/method_limits/generateBannersStatisticsReport.md -->
  ...
  |-|
  <!-- endsource: ru/_auto/method_limits/generateBannersStatisticsReport.md -->
...
- Console
  ...
  searchParams:
    ...
    - name: sourceType
      ...
      schema:
        $ref: >-
          /home/sandbox/.ya/build/build_root/jc95/00000b/market/mbi/docs/partner-api/docfiles/__docsbuild/.tmp_input/ru/openapi/partner-api-spec/common/schemas.yaml#/SourceType
        default: SELLER
  headers: []
  body: |-
    {
...
<!-- endsource: ru/api/reports/generateBannersStatisticsReport.md -->
