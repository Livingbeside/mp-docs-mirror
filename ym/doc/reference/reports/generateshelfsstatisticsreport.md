...
- Console
  ...
  schema:
    ...
    $defs:
      /home/sandbox/.ya/build/build_root/fti6/00000b/market/mbi/docs/partner-api/docfiles/__docsbuild/.tmp_input/ru/openapi/partner-api-spec/reports/schemas.yaml#/StatisticsAttributionType:
        type: string
        description: >
          Тип атрибуции:
            * `CLICKS` — по кликам.
