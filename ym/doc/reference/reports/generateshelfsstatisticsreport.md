...
alternate:
  ...
  - https://yandex.ru/dev/market/partner-api/doc/zh/reference/reports/generateShelfsStatisticsReport.md
  - href: ru/reference/reports/generateShelfsStatisticsReport.md
    type: text/markdown
...
<!-- source: ru/api/reports/generateShelfsStatisticsReport.md -->
<div class="openapi">
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/generateShelfsStatisticsReport.md -->
  ...
  * all-methods:read-only — Просмотр всех данных
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/generateShelfsStatisticsReport.md -->
  ...
  <!-- source: ru/_auto/reports/incuts/shelfs_statistics.md -->
  Пояснение к колонкам отчета:

  {% cut "Лист **Общий отчет** (файл **shelfs_statistics_summary**)" %}
  ...
  {% cut "Лист **Таргетинг по категориям** (файл **shelfs_statistics_by_category**)" %}
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/reports/incuts/shelfs_statistics.md -->
  ...
  * **Тариф «Медиум»** — доступны данные за последние 400 дней, одновременно может генерироваться до 10 отчетов
  ...
  <!-- source: ru/_auto/method_limits/generateShelfsStatisticsReport.md -->
  ...
  |-|
  <!-- endsource: ru/_auto/method_limits/generateShelfsStatisticsReport.md -->
...
- Console
  ...
  schema:
    ...
    $defs:
      /home/sandbox/.ya/build/build_root/54qq/00000b/market/mbi/docs/partner-api/docfiles/__docsbuild/.tmp_input/ru/openapi/partner-api-spec/reports/schemas.yaml#/StatisticsAttributionType:
        type: string
        description: >
          Тип атрибуции:
            * `CLICKS` — по кликам.
...
<!-- endsource: ru/api/reports/generateShelfsStatisticsReport.md -->
