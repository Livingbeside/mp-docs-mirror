...
fetched_at: "2026-09-10T01:57:00Z"
content_sha: e81ba4f4eb2ffe62
---
...
alternate:
  ...
  - https://yandex.ru/dev/market/partner-api/doc/zh/reference/reports/generateJewelryFiscalReport.md
  - href: ru/reference/reports/generateJewelryFiscalReport.md
    type: text/markdown
...
<!-- source: ru/api/reports/generateJewelryFiscalReport.md -->
<div class="openapi">
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/generateJewelryFiscalReport.md -->
  ...
  * all-methods:read-only — Просмотр всех данных
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/generateJewelryFiscalReport.md -->
  ...
  <!-- source: ru/_auto/reports/identifiers/jewelry/orders_jewelry_fiscal.md -->
  Пояснение к колонкам отчета:

  {% cut "Лист **Отчет** (файл **orders_jewelry_fiscal_report**)" %}
  ...
  || SHIFT_NUMBER | shiftNumber | Номер смены | string ||
  |#

  {% endcut %}
  <!-- endsource: ru/_auto/reports/identifiers/jewelry/orders_jewelry_fiscal.md -->
  ...
  * **Тариф «Медиум»** — одновременно может генерироваться до 10 отчетов
  ...
  <!-- source: ru/_auto/method_limits/generateJewelryFiscalReport.md -->
  ...
  |-|
  <!-- endsource: ru/_auto/method_limits/generateJewelryFiscalReport.md -->
...
<!-- endsource: ru/api/reports/generateJewelryFiscalReport.md -->
