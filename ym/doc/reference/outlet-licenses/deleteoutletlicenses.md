...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/deleteOutletLicenses.md -->
  ...
  * all-methods — Полное управление кабинетом
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/deleteOutletLicenses.md -->
  
  Удаляет информацию о лицензиях для точек продаж.
  
  <!-- source: ru/_auto/method_limits/deleteOutletLicenses.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 100 000 запросов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/deleteOutletLicenses.md -->
...
<!-- endsource: ru/api/outlet-licenses/deleteOutletLicenses.md -->
