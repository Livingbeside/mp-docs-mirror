...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/deleteCampaignOffers.md -->
  ...
  * all-methods — Полное управление кабинетом
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/deleteCampaignOffers.md -->
  ...
  <!-- source: ru/_auto/method_limits/deleteCampaignOffers.md -->
  ...
  |-|
  <!-- endsource: ru/_auto/method_limits/deleteCampaignOffers.md -->
  ...
  **Type**: object
  ...
  - {% cut "**Type**: object" %}
    ...
    {.table-cell}|
    **Type**: [DeleteCampaignOffersDTO](#entity-DeleteCampaignOffersDTO)
  ...
  * `ERROR` — при обработке запроса произошла ошибка.
  ...
  ### DeleteCampaignOffersDTO {#entity-DeleteCampaignOffersDTO}
...
<!-- endsource: ru/api/offers/deleteCampaignOffers.md -->
