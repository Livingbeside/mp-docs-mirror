...
fetched_at: "2026-09-24T02:13:48Z"
content_sha: 5c0bc44aa2772256
---
...
alternate:
  ...
  - https://yandex.ru/dev/market/partner-api/doc/zh/reference/prices/getPricesByOfferIds.md
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/getPricesByOfferIds.md -->
  ...
  * all-methods:read-only — Просмотр всех данных
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/getPricesByOfferIds.md -->
  ...
  Для просмотра цен, которые действуют во всех магазинах, используйте [POST v2/businesses/{businessId}/offer-mappings](https://yandex.ru/dev/market/partner-api/doc/ru/reference/business-offer-mappings/getOfferMappings.md).
  
  {% endnote %}
  
  <!-- source: ru/_auto/method_limits/getPricesByOfferIds.md -->
  |<div style="text-align: left;">**⚙️ Лимит без подписки:** 10 000 товаров в минуту<br>**⭐️ [Лимит с подпиской Медиум](https://yandex.ru/support/marketplace/ru/marketing/subscription):** 100 000 товаров в минуту</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/getPricesByOfferIds.md -->
  ...
  **Type**: object
  ...
  - {% cut "**Type**: object" %}
    ...
    {.table-cell}|
    **Type**: [OfferPriceByOfferIdsListResponseDTO](#entity-OfferPriceByOfferIdsListResponseDTO)
  ...
  **Для продавцов Market Yandex Go** недоступна передача и получение НДС.
  ...
  ### OfferPriceByOfferIdsResponseDTO {#entity-OfferPriceByOfferIdsResponseDTO}
  ...
  **Type**: string
  ...
  ### OfferPriceByOfferIdsListResponseDTO {#entity-OfferPriceByOfferIdsListResponseDTO}
  ...
  {.table-cell}|
  **Type**: [OfferPriceByOfferIdsResponseDTO](#entity-OfferPriceByOfferIdsResponseDTO)[]
...
<!-- endsource: ru/api/prices/getPricesByOfferIds.md -->
