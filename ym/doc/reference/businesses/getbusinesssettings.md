...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/getBusinessSettings.md -->
  ...
  * all-methods:read-only — Просмотр всех данных
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/getBusinessSettings.md -->
  
  Возвращает информацию о настройках кабинета, идентификатор которого указан в запросе.
  
  <!-- source: ru/_auto/method_limits/getBusinessSettings.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 100 запросов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/getBusinessSettings.md -->
  ...
  **Type**: object
  ...
  - {% cut "**Type**: object" %}
    ...
    {.table-cell}|
    **Type**: [GetBusinessSettingsInfoDTO](#entity-GetBusinessSettingsInfoDTO)
  ...
  **Type**: string
  ...
  ### BusinessSettingsDTO {#entity-BusinessSettingsDTO}
  ...
  * `UZS` — узбекский сум.
  ...
  _onlyDefaultPrice_{.json-schema-reset .json-schema-property}
  {.table-cell}|
  **Type**: boolean
  ...
  * `false` — можно установить цену, которая действует:
    * во всех магазинах кабинета — [POST v2/businesses/{businessId}/offer-prices/updates](https://yandex.ru/dev/market/partner-api/doc/ru/reference/prices/updateBusinessPrices.md);
    * в конкретном магазине — [POST v2/campaigns/{campaignId}/offer-prices/updates](https://yandex.ru/dev/market/partner-api/doc/ru/reference/prices/updatePrices.md).
  * `true` — можно установить только цену, которая действует во всех магазинах кабинета, — [POST v2/businesses/{businessId}/offer-prices/updates](https://yandex.ru/dev/market/partner-api/doc/ru/reference/prices/updateBusinessPrices.md).
  ...
  * `WAREHOUSE` - интерфейс единых складов на уровне кабинета.
  ...
  ### BusinessSubscriptionLevelType {#entity-BusinessSubscriptionLevelType}
  ...
  **Type**: string
  ...
  _Enum:_{.json-schema-reset .json-schema-value} `NONE`, `LIGHT`, `MEDIUM`
  
  </div>
  
  <div class="openapi-entity">
  
  ### BusinessTraitType {#entity-BusinessTraitType}
  ...
  **Type**: string
  ...
  _Const:_{.json-schema-reset .json-schema-value} `MARKET_YANDEX_GO`
  ...
  ### GetBusinessSettingsInfoDTO {#entity-GetBusinessSettingsInfoDTO}
  ...
  _info_{.json-schema-reset .json-schema-property}
  {.table-cell}|
  **Type**: [BusinessDTO](#entity-BusinessDTO)
  ...
  {.table-cell}|
  **Type**: [BusinessSettingsDTO](#entity-BusinessSettingsDTO)
  ...
  _subscriptionLevel_{.json-schema-reset .json-schema-property}
  {.table-cell}|
  **Type**: [BusinessSubscriptionLevelType](#entity-BusinessSubscriptionLevelType)
  
  Уровень подписки кабинета. Подробнее о подписке для продавцов читайте [в Справке Маркета для продавцов](https://yandex.ru/support/marketplace/ru/marketing/subscription).
  ...
  * `MEDIUM` — уровень подписки Медиум.
  ...
  _traits_{.json-schema-reset .json-schema-property}
  {.table-cell}|
  **Type**: [BusinessTraitType](#entity-BusinessTraitType)[] &#124; null
...
<!-- endsource: ru/api/businesses/getBusinessSettings.md -->
