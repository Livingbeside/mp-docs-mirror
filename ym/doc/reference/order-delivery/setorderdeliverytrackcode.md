...
<!-- source: ru/api/order-delivery/setOrderDeliveryTrackCode.md -->
<div class="openapi">
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/setOrderDeliveryTrackCode.md -->
  ...
  * all-methods — Полное управление кабинетом
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/setOrderDeliveryTrackCode.md -->
  ...
  <!-- source: ru/_auto/method_limits/setOrderDeliveryTrackCode.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 10 000 запросов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/setOrderDeliveryTrackCode.md -->
  ...
  **Type**: integer
  ...
  _trackCode_{.json-schema-reset .json-schema-property .json-schema-required}
  {.table-cell}|
  **Type**: string
  ...
  schema:
    ...
    properties:
      trackCode:
        ...
        type: string
      deliveryServiceId:
        description: "Идентификатор службы доставки. Информацию о службе доставки можно получить с помощью запроса [GET\_delivery/services](../../reference/delivery-services/getDeliveryServices.md)."
        type: integer
        format: int64
...
<!-- endsource: ru/api/order-delivery/setOrderDeliveryTrackCode.md -->
