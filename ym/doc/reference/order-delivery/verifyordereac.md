...
fetched_at: "2026-09-16T02:27:29Z"
content_sha: 3d845c8a359619b6
---
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/verifyOrderEac.md -->
  **Метод доступен для модели [Экспресс](https://yandex.ru/dev/market/partner-api/doc/ru/overview/express.md).**
  ...
  * all-methods — Полное управление кабинетом
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/verifyOrderEac.md -->
  ...
  **Если у магазина настроена работа с кодами подтверждения:**
  ...
  <!-- source: ru/_auto/method_limits/verifyOrderEac.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 10 000 запросов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/verifyOrderEac.md -->
  ...
  **Type**: object
  ...
  - {% cut "**Type**: object" %}
    ...
    {.table-cell}|
    **Type**: [EacVerificationResultDTO](#entity-EacVerificationResultDTO)
  ...
  * `ERROR` — при обработке запроса произошла ошибка.
  ...
  ### EacVerificationStatusType {#entity-EacVerificationStatusType}
  ...
  **Type**: string
  ...
  _Enum:_{.json-schema-reset .json-schema-value} `ACCEPTED`, `REJECTED`, `NEED_UPDATE`
  
  </div>
  
  <div class="openapi-entity">
  
  ### EacVerificationResultDTO {#entity-EacVerificationResultDTO}
  ...
  _attemptsLeft_{.json-schema-reset .json-schema-property}
  {.table-cell}|
  **Type**: integer
  ...
  _verificationResult_{.json-schema-reset .json-schema-property}
  {.table-cell}|
  **Type**: [EacVerificationStatusType](#entity-EacVerificationStatusType)
...
<!-- endsource: ru/api/order-delivery/verifyOrderEac.md -->
