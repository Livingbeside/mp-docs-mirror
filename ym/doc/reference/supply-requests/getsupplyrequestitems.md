...
alternate:
  ...
  - https://yandex.ru/dev/market/partner-api/doc/zh/reference/supply-requests/getSupplyRequestItems.md
  - href: https://yandex.ru/dev/market/partner-api/doc/ru/reference/supply-requests/getSupplyRequestItems.md
    type: text/markdown
...
<!-- source: ru/api/supply-requests/getSupplyRequestItems.md -->
<div class="openapi">
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/getSupplyRequestItems.md -->
  ...
  * all-methods:read-only — Просмотр всех данных
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/getSupplyRequestItems.md -->
  
  Возвращает список товаров в заявке и информацию по ним.
  
  <!-- source: ru/_auto/method_limits/getSupplyRequestItems.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 1 000 запросов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/getSupplyRequestItems.md -->
  ...
  **Type**: object
  ...
  - {% cut "**Type**: object" %}
    ...
    {.table-cell}|
    **Type**: [GetSupplyRequestItemsDTO](#entity-GetSupplyRequestItemsDTO)
  ...
  **Type**: number
  ...
  ### SupplyRequestItemCountersDTO {#entity-SupplyRequestItemCountersDTO}
  ...
  **Type**: integer
  ...
  ### SupplyRequestItemDTO {#entity-SupplyRequestItemDTO}
  ...
  {.table-cell}|
  **Type**: [SupplyRequestItemCountersDTO](#entity-SupplyRequestItemCountersDTO)
  ...
  **Type**: string
  ...
  ### GetSupplyRequestItemsDTO {#entity-GetSupplyRequestItemsDTO}
  ...
  {.table-cell}|
  **Type**: [SupplyRequestItemDTO](#entity-SupplyRequestItemDTO)[]
...
<!-- endsource: ru/api/supply-requests/getSupplyRequestItems.md -->
