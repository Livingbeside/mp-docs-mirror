...
alternate:
  ...
  - https://yandex.ru/dev/market/partner-api/doc/zh/reference/warehouses/updateWarehouseModelStatus.md
  - href: ru/reference/warehouses/updateWarehouseModelStatus.md
    type: text/markdown
...
- Info
  ...
  <!-- source: ru/_auto/method_scopes/updateWarehouseModelStatus.md -->
  ...
  * all-methods — Полное управление кабинетом
  ...
  {% endcut %}
  <!-- endsource: ru/_auto/method_scopes/updateWarehouseModelStatus.md -->
  ...
  <!-- source: ru/_auto/method_limits/updateWarehouseModelStatus.md -->
  |<div style="text-align: left;">**⚙️ Лимит:** 100 запросов в час</div>|
  |-|
  <!-- endsource: ru/_auto/method_limits/updateWarehouseModelStatus.md -->
  ...
  ```text translate=no
  https://api.partner.market.yandex.ru/v3/businesses/{businessId}/warehouse/models/status
  ```
  ...
  * `false` — отключена.
  ...
  _model_{.json-schema-reset .json-schema-property .json-schema-required}
  {.table-cell}|
  ...
  **Type**: string
  ...
  Новый статус модели работы склада.
  ...
  **Type**: object
  ...
  - {% cut "**Type**: object" %}
    ...
    {.table-cell}|
    **Type**: [WarehouseModelStatusDTO](#entity-WarehouseModelStatusDTO)
  
    Информация о статусе модели склада.
  ...
  * `ERROR` — при обработке запроса произошла ошибка.
  ...
  ### WarehouseModelStatusType {#entity-WarehouseModelStatusType}
  ...
  **Type**: string
  ...
  ### WarehouseModelStatusDTO {#entity-WarehouseModelStatusDTO}
  ...
  _status_{.json-schema-reset .json-schema-property .json-schema-required}
  {.table-cell}|
  **Type**: [WarehouseModelStatusType](#entity-WarehouseModelStatusType)
...
- Console
  ...
  schema:
    description: >
      Запрос на изменение статуса модели работы склада.
  
  
      Позволяет выключить модель работы склада или включить ранее отключенную вами
      модель.
  
  
      Если модель была отключена Маркетом, то включить её вручную с помощью этого
      метода не получится.
    type: object
    required:
      - partnerWarehouseId
    ...
    properties:
      ...
      enabled:
        ...
        type: boolean
    $defs:
      /home/sandbox/.ya/build/build_root/oxq2/00000b/market/mbi/docs/partner-api/docfiles/__docsbuild/.tmp_input/ru/openapi/partner-api-spec/common/schemas.yaml#/WarehouseProgramType:
        description: |
          Модель работы:
...
<!-- endsource: ru/api/warehouses/updateWarehouseModelStatus.md -->
