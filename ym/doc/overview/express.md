...
fetched_at: "2026-08-28T11:51:40Z"
content_sha: 30a3630f0bab7f3e
---
...
Если вы работаете по модели Экспресс, курьеры приезжают прямо к вашему складу или точке продаж, забирают упакованные заказы и тут же доставляют их покупателям. Подробнее о модели читайте в [Справке Маркета для продавцов](https://yandex.ru/support/marketplace/ru/introduction/models#express).

<!-- source: ru/_auto/methods_summary/express.md -->
## Кабинеты и магазины
...
||
|#
<!-- endsource: ru/_auto/methods_summary/express.md -->
