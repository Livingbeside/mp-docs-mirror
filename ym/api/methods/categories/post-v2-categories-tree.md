...
- `language` — string (RU, EN). Язык категорий.
...
- `result` — object. Информация о категории. Категория считается листовой, если у нее нет дочерних категорий.
  - `id` — integer<int64> **обязательный**. Идентификатор категории.
  - `name` — string **обязательный**. Название категории.
  - `children` — array[object]. Дочерние категории.
