---
title: Удаление товаров из архива
api: yandex-market
method: POST
...
- `offerIds` — array[string] **обязательный**. Список товаров, которые нужно восстановить из архива.
...
- `result` — object. Товары, которые не удалось восстановить из архива.
  - `notUnarchivedOfferIds` — array[string]. Список товаров, которые не удалось восстановить из архива.
