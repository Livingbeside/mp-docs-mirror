---
title: Удаление товаров из каталога
api: yandex-market
method: POST
...
- `offerIds` — array[string] **обязательный**. Список SKU товаров, которые нужно удалить.
...
- `result` — object. Результат удаления.
  - `notDeletedOfferIds` — array[string]. Список SKU товаров, которые не удалось удалить.
