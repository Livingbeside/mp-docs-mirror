---
title: Информация о заказах в магазине
api: yandex-market
method: GET
...
- `orders` — array[object] **обязательный**. Модель заказа.
