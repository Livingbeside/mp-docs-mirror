...
operation_id: generateKeyIndicatorsReport
tags:
  - reports
  - fby
  - fbs
...
- `detalizationLevel` — string (WEEK, MONTH) **обязательный**. За какой период нужна детализация.
