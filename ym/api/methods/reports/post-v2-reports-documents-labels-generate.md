---
title: Готовые ярлыки‑наклейки на все коробки в нескольких заказах
api: yandex-market
method: POST
...
- `sortingType` — string (SORT_BY_GIVEN_ORDER, SORT_BY_ORDER_CREATED_AT). Тип сортировки ярлыков в файле.
