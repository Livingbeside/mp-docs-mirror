...
14 апреля 2025 года метод будет отключён. Переключитесь на [/v2/product/certification/list](#operation/ProductAPI_ProductCertificationList).
