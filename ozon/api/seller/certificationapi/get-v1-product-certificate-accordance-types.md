---
title: Список типов соответствия требованиям (версия 1)
api: ozon-seller
method: GET
path: /v1/product/certificate/accordance-types
operation_id: ProductAPI_ProductCertificateAccordanceTypes
tags:
  - CertificationAPI
spec_version: 2.1
source: "https://docs.ozon.ru/api/seller/"
deprecated: false
content_sha: 48018a646d6d1a71
---
...
- `result` — array[object]. Список типов и названий сертификатов.
