...
Для каждого товара вы можете загрузить до 50 изображений.
...
- `images` — ?. Массив ссылок на изображения. Изображения в массиве расположены в порядке их расположения на сайте. Первое изображение в массиве будет главным.
