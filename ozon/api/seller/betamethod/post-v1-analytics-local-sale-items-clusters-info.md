---
title: Получить информацию о локальности продаж товара по кластерам
api: ozon-seller
method: POST
path: /v1/analytics/local-sale/items-clusters/info
operation_id: AnalyticsLocalSaleItemsClustersInfo
tags:
  - BetaMethod
spec_version: 2.1
source: "https://docs.ozon.ru/api/seller/"
deprecated: false
content_sha: 7a5d0b2459c19afb
---
...
- `filter` — object **обязательный**. Фильтр.
  ...
  - `macrolocal_cluster_to_ids` — array[string<int64>]. Идентификатор кластера доставки. Получите методом [/v2/cluster/list](#operation/DraftClusterList).
  ...
  - `skus` — array[string] **обязательный**. Идентификатор товара в системе Ozon — SKU.
...
- `items` — array[object]. Список товаров.
  - `macrolocal_cluster_to_id` — integer<int64>. Кластер доставки.
