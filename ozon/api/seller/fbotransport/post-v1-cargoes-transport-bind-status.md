---
title: Получить статус связывания или отвязывания грузомест и транспортных грузомест
api: ozon-seller
method: POST
path: /v1/cargoes/transport/bind/status
operation_id: CargoesTransportBindStatus
tags:
  - FBOTransport
spec_version: 2.1
source: "https://docs.ozon.ru/api/seller/"
deprecated: false
content_sha: 8f50baef0078a998
---
...
- `operation_id` — string **обязательный**. Идентификатор операции из метода [/v1/cargoes/transport/bind](#operation/CargoesTransportBind).
...
- `status` — string (SUCCESS, IN_PROGRESS, FAILED). Статус связывания или отвязывания грузомест: - `SUCCESS` — успешно; - `IN_PROGRESS` — в процессе; - `FAILED` — ошибка.
