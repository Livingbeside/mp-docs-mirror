---
title: Получить список таймслотов для обновления склада с отгрузкой drop-off
api: ozon-seller
method: POST
path: /v1/warehouse/fbs/update/drop-off/timeslot/list
operation_id: WarehouseFbsUpdateDropOffTimeslotList
tags:
  - FBSWarehouseSetup
spec_version: 2.1
source: "https://docs.ozon.ru/api/seller/"
deprecated: false
content_sha: 9aca16b19cc95585
---
