---
title: Передать отправление к отгрузке
api: ozon-seller
method: POST
path: /v2/posting/fbs/awaiting-delivery
operation_id: PostingAPI_MoveFbsPostingToAwaitingDelivery
tags:
  - FBS
spec_version: 2.1
source: "https://docs.ozon.ru/api/seller/"
deprecated: false
content_sha: 7748f8121ad8de88
---
...
- `posting_number` — array[string] **обязательный**. Идентификатор отправления. Максимальное количество в одном запросе — 100.
