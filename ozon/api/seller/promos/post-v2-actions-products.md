---
title: Получить список товаров, которые участвуют в акции
api: ozon-seller
method: POST
path: /v2/actions/products
operation_id: ActionsProducts
tags:
  - Promos
spec_version: 2.1
source: "https://docs.ozon.ru/api/seller/"
deprecated: false
content_sha: eeba75ff931683ea
---
...
До 13 октября 2026 года метод работает аналогично [/v1/actions/products](#operation/PromosProducts).
...
- `products` — array[object]. Список товаров.
  ...
  - `add_mode` — string (SELLER, AUTO). Тип добавления товара в акцию: - `AUTO` — автоматически; - `SELLER` — вручную продавцом.
  ...
  - `stock` — integer<uint64>. Число единиц товара в акции типа «Скидка на сток».
