---
title: Получить типы пуш-уведомлений
api: ozon-seller
method: POST
path: /v1/notification/push-type/list
operation_id: GetNotificationPushTypeList
tags:
  - Notification
spec_version: 2.1
source: "https://docs.ozon.ru/api/seller/"
deprecated: false
content_sha: db2592e83c84da7b
---
...
- `types` — array[object] **обязательный**. Типы пуш-уведомлений.
