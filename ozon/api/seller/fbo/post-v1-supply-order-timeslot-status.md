---
title: Статус интервала поставки
api: ozon-seller
method: POST
path: /v1/supply-order/timeslot/status
operation_id: SupplyOrderAPI_GetSupplyOrderTimeslotStatus
tags:
  - FBO
spec_version: 2.1
source: "https://docs.ozon.ru/api/seller/"
deprecated: false
content_sha: 6b47861a489dbbd4
---
...
- `status` — string (STATUS_UNSPECIFIED, STATUS_ERROR, STATUS_IN_PROGRESS, STATUS_SUCCESS). Статус данных: - `UNSPECIFIED` — не указан; - `ERROR` — ошибка; - `IN_PROGRESS` — устанавливается; - `SUCCESS` — установлен. По умолчанию: `STATUS_UNSPECIFIED`.
