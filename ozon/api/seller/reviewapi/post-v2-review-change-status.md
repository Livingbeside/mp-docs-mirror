...
operation_id: ReviewChangeStatusV2
tags:
  - ReviewAPI
spec_version: 2.1
source: "https://docs.ozon.ru/api/seller/"
deprecated: false
content_sha: 67d995a5bafaf013
---
...
- `review_ids` — array[string]. Список идентификаторов отзывов.
- `status` — string (NEW, VIEWED, PROCESSED). Новый статус отзыва: - `NEW` — новый; - `VIEWED` — просмотренный; - `PROCESSED` — обработанный.
