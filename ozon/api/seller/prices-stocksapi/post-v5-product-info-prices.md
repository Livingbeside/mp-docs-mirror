...
- `items` — ?. Список товаров.
  ...
  - `price` — object. Цена товара.
    ...
    - `marketing_seller_price` — number<double>. Цена на товар с учётом акций продавца.
    - `min_price` — number<double>. Минимальная цена товара после применения всех скидок.
    ...
    - `price` — number<double>. Цена товара с учётом скидок — это значение показывается на карточке товара.
