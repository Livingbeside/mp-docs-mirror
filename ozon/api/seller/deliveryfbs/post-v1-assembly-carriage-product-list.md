---
title: Получить список товаров в отгрузке
api: ozon-seller
method: POST
path: /v1/assembly/carriage/product/list
operation_id: AssemblyCarriageProductList
tags:
  - DeliveryFBS
spec_version: 2.1
source: "https://docs.ozon.ru/api/seller/"
deprecated: false
content_sha: d25aabffdbc8f8af
---
...
- `filter` — object **обязательный**. Фильтр.
  ...
  - `delivery_method_id` — integer<int64>. Идентификатор метода доставки. Можно получить с помощью метода [/v1/delivery-method/list](#operation/WarehouseAPI_DeliveryMethodList).
