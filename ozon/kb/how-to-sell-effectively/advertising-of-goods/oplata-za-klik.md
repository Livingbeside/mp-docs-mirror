...
marketplace: ozon
kind: section
path: /how-to-sell-effectively/advertising-of-goods/oplata-za-klik
...
Инструмент для продвижения карточек товаров в поисковой выдаче и рекомендациях
...
- [Как посмотреть результаты по кампании в «Оплате за клик»](https://seller-edu.ozon.ru/libra/how-to-sell-effectively/advertising-of-goods/oplata-za-klik/rezultaty-v-oplate-za-klik)
