---
title: Продажа со своего склада (realFBS)
marketplace: ozon
kind: section
path: /rfbs
...
Как подключить доставку любым сторонним перевозчиком или возить заказы покупателям самостоятельно

## Вложенные разделы
- [Схемы работы](https://seller-edu.ozon.ru/libra/rfbs/scheme-of-work)
- [Склады и методы доставки](https://seller-edu.ozon.ru/libra/rfbs/logistics-settings)
- [Заказы](https://seller-edu.ozon.ru/libra/rfbs/orders-cancellations)
- [Спорные заказы, отмены и возвраты](https://seller-edu.ozon.ru/libra/rfbs/vozvraty)
